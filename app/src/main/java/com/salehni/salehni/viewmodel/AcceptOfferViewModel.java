...
public class AcceptOfferViewModel extends AndroidViewModel implements InterfaceApi {

    public MutableLiveData<Boolean> acceptOfferStatusModelMutableLiveData = new MutableLiveData<>();
    ...
    public AcceptOfferViewModel(@NonNull Application application) {
        super(application);

        this.context = application.getApplicationContext();
    }

    public void getData(RequestOffersModel requestOffersModel) {
        ...
        if (Global.isNetworkAvailable(context)) {
            ...
            try {
                jsonObject.put("user_id", requestOffersModel.getId());
                jsonObject.put("provider_id", requestOffersModel.getProvider_id());
                jsonObject.put("request_id", requestOffersModel.getRequest_id());
            ...
            apiData.getdata(this.getApplication(), this, Constants.main_url + Constants.userAcceptOffer_Url, headerParams, mRequestBody);
    ...
    public void callbackOnSuccess(String response) {
        ...
        if (status) {
            acceptOfferStatusModelMutableLiveData.setValue(status);
        } else {
